...
import { FaUniversity, FaClipboardList, FaRunning, FaBasketballBall, FaBowlingBall, FaTrophy } from "react-icons/fa";
    ...
    <div className="mx-10 w-full flex justify-center">
      <div className="w-full my-8 p-6 bg-[#c9a3ef] text-white rounded-xl shadow-lg">
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-xl md:text-3xl text-purple-900 mt-3">{player.category}</p>
        </div>
